...
Debe tener la capacidad de poder describir formalmente un problema, en el resumen se debe dar contexso sobre el problema para luego plantear el problema.
...
Esta sección debe plantear el problema, incluyendo las referencia ~\nameref{sec:references}.\autocite{Cooper2009} al este problema u otras que ayuden a entender el problema.
